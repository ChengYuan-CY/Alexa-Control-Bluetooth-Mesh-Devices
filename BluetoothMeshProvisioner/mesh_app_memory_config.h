...
#define MESH_CFG_MAX_PROVISIONED_DEVICES        100
#define MESH_CFG_MAX_PROVISIONED_DEVICE_APPKEYS 3
#define MESH_CFG_MAX_PROVISIONED_DEVICE_NETKEYS 3
#define MESH_CFG_MAX_FOUNDATION_CLIENT_CMDS     10
